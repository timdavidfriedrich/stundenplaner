...
var niceWhite = GoogleFonts.montserrat(fontSize: 12, color: Colors.white);
var niceBlack = GoogleFonts.montserrat(fontSize: 12, color: Colors.black);
var niceRed = GoogleFonts.montserrat(
    fontSize: 12, fontWeight: FontWeight.w500, color: Colors.redAccent);
var niceGreen = GoogleFonts.montserrat(
    fontSize: 12, fontWeight: FontWeight.w500, color: Colors.greenAccent[700]);
